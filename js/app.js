...
// var CELULAR_EMPRESA = "5567991048034";
var CELULAR_EMPRESA = "5567996000022";
...
cardapio.metodos = {
  ...
  finalizarPedido: () => {
    if (MEU_CARRINHO.length > 0 && MEU_ENDERECO != null) {
      ...
      texto += `${itens}\n`;
      texto += "*Endereço para entrega:*\n";
      texto += `${MEU_ENDERECO.endereco}, ${MEU_ENDERECO.numero}, ${MEU_ENDERECO.bairro}\n`;
      texto += `${MEU_ENDERECO.cidade} - ${MEU_ENDERECO.uf} • CEP: ${MEU_ENDERECO.cep}\n`;
      ...
      texto += `\n*Total com entrega:* R$ ${(VALOR_CARRINHO + VALOR_ENTREGA)
        .toFixed(2)
        .replace(".", ",")}\n`;
      texto += "\n*Obrigado!* Aguardando confirmação. ✔";
